...
For three clusters, we see that the clusters are best separated by the variable tax, although even then there is some mixing between the red and green clusters.
